...
public class ModelForestWalker extends ModelBase
{
    ...
    public ModelForestWalker()
    {
        this(0.0F);
    }

    public ModelForestWalker(float par1)
    {
        this(par1, -7.0F);
    }

    public ModelForestWalker(float par1, float par2)
    {
        short short1 = 128;
        short short2 = 128;
