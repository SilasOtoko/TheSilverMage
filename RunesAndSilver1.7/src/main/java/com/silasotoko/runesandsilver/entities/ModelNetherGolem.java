...
public class ModelNetherGolem extends ModelBase
{
    ...
    public ModelNetherGolem(float par1)
    {
        this(par1, -7.0F);
    }

    public ModelNetherGolem(float par1, float par2)
    {
        short short1 = 128;
        short short2 = 128;
    ...
    {
        EntityNetherGolem entityforestwalker = (EntityNetherGolem)par1EntityLivingBase;
