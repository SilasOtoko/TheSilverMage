...
public class EntityRunestoneGolem extends EntityCreature
{
	private int attackTimer;
	

	public EntityRunestoneGolem(World par1World){
		super(par1World);
   ...
   {
       if (par1Entity instanceof IMob && !(par1Entity instanceof EntityRunestoneGolem) && !(par1Entity instanceof EntityCreeper) && this.getRNG().nextInt(20) == 0)
       {
   ...
   {
       return EntityRunestoneGolem.class != par1Class && EntityCreeper.class != par1Class;
   }
   ...
   protected void dropFewItems(boolean par1, int par2)
   {
       ...
       for (int l = 0; l < k; ++l)
       {
           this.dropItem(ModItems.BlankRune, 2);
       }
   }
