...
public class ModelSnowGolem extends ModelBase
{
    ...
    public ModelSnowGolem(float par1)
    {
        this(par1, -7.0F);
    }

    public ModelSnowGolem(float par1, float par2)
    {
        short short1 = 128;
        short short2 = 128;
    ...
    {
        EntitySnowGolem entity = (EntitySnowGolem)par1EntityLivingBase;
