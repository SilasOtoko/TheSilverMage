...
public class ModelRunestoneGolem extends ModelBase
{
    ...
    public ModelRunestoneGolem()
    {
        this(0.0F);
    }

    public ModelRunestoneGolem(float par1)
    {
        this(par1, -7.0F);
    }

    public ModelRunestoneGolem(float par1, float par2)
    {
        short short1 = 128;
        short short2 = 128;
    ...
    {
        EntityRunestoneGolem entityRunestoneGolem = (EntityRunestoneGolem)par1EntityLivingBase;
        int i = entityRunestoneGolem.getAttackTimer();
