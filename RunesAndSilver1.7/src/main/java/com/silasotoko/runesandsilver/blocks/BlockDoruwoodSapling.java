...
public class BlockDoruwoodSapling extends BlockSapling
{
    public static final String[] saplings = new String[] {"Doruwood"};
    private static final IIcon[] iconLength = new IIcon[saplings.length];

    public BlockDoruwoodSapling()
    {
        float f = 0.4F;
    ...
    public void func_149878_d(World world, int x, int y, int z, Random random)
    {
        ...
        switch (l)
        	{
            case 0:
            	object = new WorldGenDoruwoodTree(true);
            	break;
            case 1:
            	break;
            case 2:
    ...
    public void registerBlockIcons(IIconRegister icon)
    {
        ...
        {
            iconLength[i] = icon.registerIcon(Reference.MOD_ID + ":" + this.getUnlocalizedName().substring(5) + "_" + saplings[i]);
        }
    }
