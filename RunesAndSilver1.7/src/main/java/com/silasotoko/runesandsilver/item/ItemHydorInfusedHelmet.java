...
public class ItemHydorInfusedHelmet extends ItemArmor {
	public ItemHydorInfusedHelmet(ArmorMaterial material, int armorType, String name){
		super(material, 0, armorType);
		this.setCreativeTab(RunesAndSilver.tabRunesAndSilver);
		this.setUnlocalizedName("HydorInfusedHelmet");
	}
	
	@Override
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type){
		if(stack.getItem()== ModItems.HydorInfusedHelmet){
			return Reference.MOD_ID + ":models/armor/HydorInfusedArmor.png";
		}
		else{
			System.out.println("Invalid Item HydorInfusedHelmet");
			return null;
		}
	}
