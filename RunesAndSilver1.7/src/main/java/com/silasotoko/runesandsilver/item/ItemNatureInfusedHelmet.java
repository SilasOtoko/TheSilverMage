...
public class ItemNatureInfusedHelmet extends ItemArmor {
	public ItemNatureInfusedHelmet(ArmorMaterial material, int armorType, String name){
		super(material, 0, armorType);
		this.setCreativeTab(RunesAndSilver.tabRunesAndSilver);
		this.setUnlocalizedName("NatureInfusedHelmet");
	}
	
	@Override
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type){
		if(stack.getItem()== ModItems.NatureInfusedHelmet){
			return Reference.MOD_ID + ":models/armor/NatureInfusedArmor.png";
		}
		else{
			System.out.println("Invalid Item NatureInfusedHelmet");
			return null;
		}
	}
