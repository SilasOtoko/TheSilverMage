...
public class ItemNatureRuneChestplate extends ItemArmor {
	public ItemNatureRuneChestplate(ArmorMaterial material, int armorType, String name){
		super(material, 0, armorType);
		this.setCreativeTab(RunesAndSilver.tabRunesAndSilver);
		this.setUnlocalizedName("NatureRuneChestplate");
	}
	
	@Override
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type){
		if(stack.getItem()== ModItems.NatureRuneChestplate){
			return Reference.MOD_ID + ":models/armor/NatureRuneArmor.png";
		}
		else{
			System.out.println("Invalid Item NatureRuneChestplate");
			return null;
		}
	}
