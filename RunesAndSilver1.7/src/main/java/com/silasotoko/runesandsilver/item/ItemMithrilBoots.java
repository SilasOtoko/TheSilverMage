...
public class ItemMithrilBoots extends ItemArmor {
	public ItemMithrilBoots(ArmorMaterial material, int armorType, String name){
		super(material, 0, armorType);
		this.setCreativeTab(RunesAndSilver.tabRunesAndSilver);
		this.setUnlocalizedName("MithrilBoots");
	}
	
	@Override
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type){
		if(stack.getItem()== ModItems.MithrilBoots){
			return Reference.MOD_ID + ":models/armor/MithrilArmor.png";
		}
		else{
			System.out.println("Invalid Item MithrilBoots");
			return null;
		}
	}
