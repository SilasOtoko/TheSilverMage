...
public class ItemWildOnion extends ItemFood{
    ...
    public ItemWildOnion(int hunger, float saturation, boolean p_i45339_3_)
    {
    	super(hunger, saturation, p_i45339_3_);
        this.itemUseDuration = 32;
        this.healAmount = hunger;
        this.isWolfsFavoriteMeat = p_i45339_3_;
        this.saturationModifier = saturation;
        this.setCreativeTab(RunesAndSilver.tabRunesAndSilver);
		this.setUnlocalizedName("WildOnion");
    }

    public ItemWildOnion(int p_i45340_1_, boolean p_i45340_2_)
    {
