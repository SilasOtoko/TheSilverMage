...
public class ItemNatureRuneHelmet extends ItemArmor {
	public ItemNatureRuneHelmet(ArmorMaterial material, int armorType, String name){
		super(material, 0, armorType);
		this.setCreativeTab(RunesAndSilver.tabRunesAndSilver);
		this.setUnlocalizedName("NatureRuneHelmet");
	}
	
	@Override
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type){
		if(stack.getItem()== ModItems.NatureRuneHelmet){
			return Reference.MOD_ID + ":models/armor/NatureRuneArmor.png";
		}
		else{
			System.out.println("Invalid Item NatureRuneHelmet");
			return null;
		}
	}
