...
public class ItemNatureInfusedBoots extends ItemArmor {
	public ItemNatureInfusedBoots(ArmorMaterial material, int armorType, String name){
		super(material, 0, armorType);
		this.setCreativeTab(RunesAndSilver.tabRunesAndSilver);
		this.setUnlocalizedName("NatureInfusedBoots");
	}
	
	@Override
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type){
		if(stack.getItem()== ModItems.NatureInfusedBoots){
			return Reference.MOD_ID + ":models/armor/NatureInfusedArmor.png";
		}
		else{
			System.out.println("Invalid Item NatureInfusedBoots");
			return null;
		}
	}
