...
public class ItemCookedMutton extends ItemFood{
	    ...
	    public ItemCookedMutton(int hunger, float saturation, boolean p_i45339_3_)
	    {
			...
			this.setUnlocalizedName("CookedMutton");
	    }

	    public ItemCookedMutton(int p_i45340_1_, boolean p_i45340_2_)
	    {
