...
public class ItemSilverLeggings extends ItemArmor {
	public ItemSilverLeggings(ArmorMaterial material, int armorType, String name){
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type){
		if(stack.getItem()== ModItems.SilverLeggings){
			return Reference.MOD_ID + ":models/armor/SilverArmor2.png";
		}
		else{
			System.out.println("Invalid Item SilverLeggings");
			return null;
		}
	}
