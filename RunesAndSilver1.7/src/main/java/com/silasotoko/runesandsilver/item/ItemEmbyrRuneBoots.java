...
public class ItemEmbyrRuneBoots extends ItemArmor {
	public ItemEmbyrRuneBoots(ArmorMaterial material, int armorType, String name){
		super(material, 0, armorType);
		this.setCreativeTab(RunesAndSilver.tabRunesAndSilver);
		this.setUnlocalizedName("EmbyrRuneBoots");
	}
	
	@Override
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type){
		if(stack.getItem()== ModItems.EmbyrRuneBoots){
			return Reference.MOD_ID + ":models/armor/EmbyrRuneArmor.png";
		}
		else{
			System.out.println("Invalid Item EmbyrRuneBoots");
			return null;
		}
	}
