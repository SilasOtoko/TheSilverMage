...
public class ItemEmbyrRuneChestplate extends ItemArmor {
	public ItemEmbyrRuneChestplate(ArmorMaterial material, int armorType, String name){
		super(material, 0, armorType);
		this.setCreativeTab(RunesAndSilver.tabRunesAndSilver);
		this.setUnlocalizedName("EmbyrRuneChestplate");
	}
	
	@Override
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type){
		if(stack.getItem()== ModItems.EmbyrRuneChestplate){
			return Reference.MOD_ID + ":models/armor/EmbyrRuneArmor.png";
		}
		else{
			System.out.println("Invalid Item EmbyrRuneChestplate");
			return null;
		}
	}
