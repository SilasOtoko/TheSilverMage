...
public class ItemSilverBoots extends ItemArmor {
	public ItemSilverBoots(ArmorMaterial material, int armorType, String name){
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type){
		if(stack.getItem()== ModItems.SilverBoots){
			return Reference.MOD_ID + ":models/armor/SilverArmor.png";
		}
		else{
			System.out.println("Invalid Item SilverBoots");
			return null;
		}
	}
