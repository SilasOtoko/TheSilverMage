...
public class ItemMithrilHelmet extends ItemArmor {
	public ItemMithrilHelmet(ArmorMaterial material, int armorType, String name){
		super(material, 0, armorType);
		this.setCreativeTab(RunesAndSilver.tabRunesAndSilver);
		this.setUnlocalizedName("MithrilHelmet");
	}
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type){
		if(stack.getItem()== ModItems.MithrilHelmet){
			...
			System.out.println("Invalid Item MithrilHelmet");
			return null;
		}
	}
