...
public class ItemSilverHelmet extends ItemArmor {
	public ItemSilverHelmet(ArmorMaterial material, int armorType, String name){
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type){
		if(stack.getItem()== ModItems.SilverHelmet){
			return Reference.MOD_ID + ":models/armor/SilverArmor.png";
		}
		else{
			System.out.println("Invalid Item SilverHelmet");
			return null;
		}
	}
