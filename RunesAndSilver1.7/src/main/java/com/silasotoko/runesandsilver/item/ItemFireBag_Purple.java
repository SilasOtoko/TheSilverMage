...
public class ItemFireBag_Purple extends ItemRS {
	public ItemFireBag_Purple(){
		super();
		this.maxStackSize = 1;
		this.setMaxDamage(30);
		this.setCreativeTab(RunesAndSilver.tabRunesAndSilver);
		this.setUnlocalizedName("EmbyrPowderPurple");
	}
	    ...
	    public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_, World p_77648_3_, int p_77648_4_, int p_77648_5_, int p_77648_6_, int p_77648_7_, float p_77648_8_, float p_77648_9_, float p_77648_10_)
	    {
	        ...
	        else
	        {
	            if (p_77648_3_.isAirBlock(p_77648_4_, p_77648_5_, p_77648_6_))
	            {
	                ...
	                p_77648_3_.setBlock(p_77648_4_, p_77648_5_, p_77648_6_, ModBlocks.Fire_Purple);
	            }
