...
public class ItemSilverChestplate extends ItemArmor {
	public ItemSilverChestplate(ArmorMaterial material, int armorType, String name){
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type){
		if(stack.getItem()== ModItems.SilverChestplate){
			return Reference.MOD_ID + ":models/armor/SilverArmor.png";
		}
		else{
			System.out.println("Invalid Item SilverChestplate");
			return null;
		}
	}
