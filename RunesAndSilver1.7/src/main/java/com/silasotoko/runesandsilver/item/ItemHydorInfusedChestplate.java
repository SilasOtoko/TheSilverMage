...
public class ItemHydorInfusedChestplate extends ItemArmor {
	public ItemHydorInfusedChestplate(ArmorMaterial material, int armorType, String name){
		super(material, 0, armorType);
		this.setCreativeTab(RunesAndSilver.tabRunesAndSilver);
		this.setUnlocalizedName("HydorInfusedChestplate");
	}
	
	@Override
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type){
		if(stack.getItem()== ModItems.HydorInfusedChestplate){
			return Reference.MOD_ID + ":models/armor/HydorInfusedArmor.png";
		}
		else{
			System.out.println("Invalid Item HydorInfusedChestplate");
			return null;
		}
	}
